exports.command = {
	name: 'rank',
	description: 'Zeigt dir die Rankcard von dir oder einer beliebigen Person',
    roles: [],

    options: [
        {
        "name": "user",
        "description": "Person dessen Rankcard du abfragen möchtest",
        "type": 6,
        "required": false
        },
    ],
    ...
    client.api.interactions(int.id, int.token).callback.post({data: {type: 5}})
